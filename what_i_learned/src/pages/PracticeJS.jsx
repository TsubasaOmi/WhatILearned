...
const PracticeJS = () => {
  return (
    <div>
      ...
      {/* <input type="button" value="テスト"></input>

      <nav class="js-slidepanel table-of-content is-chapter is-active-slide">
        <h2 class="js-button-slidepanel table-of-content-title icon-plus">
          目次
        </h2>
        <ol class="table-of-content-list is-hidden-sp" style="height: 239px;">
          <li>
            <a href="#sec1" class="is-visited">
              今回の概要と目標
            </a>
          </li>
          <li>
            <a href="#garbled-characters" class="is-visited is-active">
              文字化けの原因
            </a>
          </li>
          <li>
            <a href="#character-set">文字コードの指定方法</a>
          </li>
          <li>
            <a href="#exercises">文字コードを指定してみよう</a>
          </li>
          <li>
            <a href="#traning">練習問題</a>
          </li>
          <li>
            <a href="#matome">まとめ</a>
          </li>{" "}
